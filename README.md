...
* ↕️ **Collapsible Sidebar** – Hide/show sidebar as needed.
* 🛬 **Landing Page** – Welcoming homepage for new users.
...
The concept of RegNote is inspired by the popular applications Notion and Trello. It combines features from both platforms to provide a streamlined and efficient solution for managing class notes.
By merging the organizational capabilities of Trello with the rich content management tools of Notion, RegNote offers:
...
*Add relevant screenshots showing UI/UX, dashboard, board creation, note sharing, mobile view, etc.*
