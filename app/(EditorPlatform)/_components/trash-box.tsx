...
export const TrashBox = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-sm h-full w-full overflow-hidden">
      <div className="flex items-center justify-center p-2">
        <Input
          ...
          className={
            `h-8 w-[26rem] px-2 bg-neutral-700/40 
      ...
      <div className="h-[15rem] w-full">
        ...
        <div className="h-full w-full overflow-auto">
          {filteredDocuments && filteredDocuments.length > 0 ? (
            ...
            <div className="flex flex-col px-1 items-center justify-center h-[12rem] w-full">
