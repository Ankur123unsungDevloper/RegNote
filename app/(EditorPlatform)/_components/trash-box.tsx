    ...
    <div className="flex flex-col items-center justify-center text-sm h-full w-full">
      <div className="flex items-center justify-center p-2">
        <Input
          ...
          className="h-8 w-[27rem] px-2 focus-visible:ring-transparent bg-neutral-700/40 data-[state=active]:border-[3px] data-[state=active]:border-blue-500"
        />
      </div>
      ...
      <div className="flex last:block flex-col mt-4 px-1 items-center justify-center h-[15rem] w-full">
      ...
      <div className="flex flex-row items-center bg-gray-800 w-full rounded-sm p-2 gap-x-16">
